...
These docs cover Mono-specific topics like setting up and configuring Mono, information about Mono internals such as the runtime and garbage collector, and various Mono-specific tools.
